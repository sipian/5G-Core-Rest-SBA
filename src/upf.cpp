...
// string g_upf_sgi_ip_addr = "172.26.0.7";
// string g_sink_ip_addr = "172.26.0.8";
...
void Upf::handle_create_session(struct sockaddr_in src_sock_addr, Packet pkt){
	...
	cout<<"s11_cteid_upf: "<<s11_cteid_upf<<endl;
	cout<<"uteid_ul"<<s1_uteid_ul<<endl;
	cout<<"imsi: "<<imsi<<endl;
	cout<<"ue_ip_addr"<<ue_ip_addr<<endl;
...
void Upf::handle_modify_bearer(struct sockaddr_in src_sock_addr, Packet pkt) {
	...
	cout<<"teid"<<pkt.gtp_hdr.teid<<endl;
	cout<<"imsi"<<imsi<<endl;
	if (imsi == 0) {
